...
// async clause¡ª¡ªthe parallel, kernels, or serial region or data operations may be
// processed asynchronously while the local thread continues with the code following the construct or
// directive.
...
//optimize operation 
		...
		#pragma acc parallel loop copyin(A[0:nsize*nsize]) async
		for (i = 0; i < nsize; ++i) 
		{
      		TYPE rsum = (TYPE)0;
